...
def main_cimo(user_size,edge_size,res_size,bids_1, S_1, v_1, caps_1, THP_edge_1, bandwidth_1):
    # 代码开始运行
    ...
    # bids = [300.0, 258.0, 300.0]
    # S = [[3, 1, 1], [2, 1, 2], [2, 4, 3]]
    # v = [700, 300, 500]
    # caps = [[5, 50], [5, 50]]
    # THP_edge = [20, 30]
    # bandwidth = [[1, 1], [2, 2], [3, 3]]

    # 临时测试
    # user_size, edge_size, res_size = 10, 5, 1  # 用户数量, edge数量, 资源类型数量
    # bids = [33.0, 31.0, 22.0, 12.0, 17, 25.0, 44.0, 33.0, 28.0, 37.0]
    # S = [[12.5, 7.0], [7.12, 7.0], [13.94, 6.0], [12.29, 8.0], [8.44, 5.0], [10.89, 7.0], [13.33, 6.0], [15.58, 7.0],
    #      [12.35, 9.0], [6.29, 4.0]]
    # v = [5.68, 20.14, 26.74, 16.48, 22.34, 180.09, 53.79, 21.18, 80.08, 27.16]
    ...
    def best_i(win, wait):
        ...
        for i in range(len(wait)):
            ...
            if xx > max_temp:
                max_temp = xx
                max_i = i_temp
                # print("-----------用户", max_i, "暂时第一,增幅为", max_temp)
        return max_i
    ...
    print()
    print('社会福利')
    value = value_of_win(win, bids, v, S)
    print(value)
