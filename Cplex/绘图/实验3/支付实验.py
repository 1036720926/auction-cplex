...
# 每种类型的柱状图宽度
width = total_width / n
list1 = [11551.825414657593, 12135.16309299469, 12394.032818412781, 12145.777388191224]
list2 = [12319.352, 12654.338000000007, 12498.379999999988, 12278.960000000008]
# 贪婪法的出价在原有的数据/10
list3 = [314000, 378000, 372000, 386000]
